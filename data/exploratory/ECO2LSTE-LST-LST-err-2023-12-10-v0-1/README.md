...
## 1. Request Parameters  
    ...
    Name: ECO2LSTE-LST-LST_err-2023-12-10-v0.1  

    Date Completed:** 2023-12-10T21:09:17.531998  

    ID: a94caafb-e04e-4556-89fd-aa2ed9a409ca  
...
- Comma-separated values file with data extracted for a specific product
  - ECO2LSTE-LST-LST-err-2023-12-10-v0-1-ECO2LSTE-001-results.csv
- Text file with data pool URLs for all source granules used in the extraction
  - ECO2LSTE-LST-LST-err-2023-12-10-v0-1-granule-list.txt
- JSON request file which can be used in AppEEARS to create a new request
  - ECO2LSTE-LST-LST-err-2023-12-10-v0-1-request.json
- xml file
  - ECO2LSTE-LST-LST-err-2023-12-10-v0-1-ECO2LSTE-001-metadata.xml  
...
- Hook, S., Hulley, G. (2019). ECOSTRESS Land Surface Temperature and Emissivity Daily L2 Global 70 m V001. NASA EOSDIS Land Processes Distributed Active Archive Center. Accessed 2023-12-10 from https://doi.org/10.5067/ECOSTRESS/ECO2LSTE.001. Accessed December 10, 2023.
